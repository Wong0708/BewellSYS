    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
          ...
          <div class="notify"><span class="heartbit"></span><span class="point"></span></div>
                    ...
                    <!-- /.dropdown -->
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="../plugins/images/users/varun.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">Jet</b> </a>
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li class="user-pro">
                        <a href="#" class="waves-effect"><img src="../plugins/images/users/varun.jpg" alt="user-img" class="img-circle"> <span class="hide-menu"> Jet Tamani<span class="fa arrow"></span></span>
                        </a>
                    ...
                    <li><a href="index.html" class="waves-effect"><i class="linea-icon linea-aerrow fa-fw" data-icon="&#xe078;"></i> <span class="hide-menu">Dashboard</span></a></li>
                    ...
                    <li><a href="index.html" class="waves-effect"><i class="linea-icon linea-ecommerce fa-fw"  data-icon="D"></i> <span class="hide-menu">Place Order</span></a></li>
                    <li><a href="index.html" class="waves-effect"><i class="linea-icon linea-basic fa-fw"  data-icon="&#xe017;"></i> <span class="hide-menu">Place Schedule</span></a></li>
                    <li><a href="index.html" class="waves-effect"><i class="linea-icon linea-ecommerce fa-fw"  data-icon="x"></i> <span class="hide-menu">View Orders</span></a></li>
                    <li><a href="index.html" class="waves-effect"><i class="linea-icon linea-basic fa-fw"  data-icon="r"></i> <span class="hide-menu">View Schedule</span></a></li>
                    
                    <li class="nav-small-cap">--- Inventory</li>
                    <li><a href="index.html" class="waves-effect"><i class="linea-icon linea-ecommerce fa-fw"  data-icon="Z"></i> <span class="hide-menu">View Material Inventory</span></a></li>
                    <li><a href="index.html" class="waves-effect"><i class="linea-icon linea-ecommerce fa-fw"  data-icon="b"></i> <span class="hide-menu">View Product Inventory</span></a></li>

                    {{--  <li><a href="documentation.html" class="waves-effect"><i class="fa fa-circle-o text-danger"></i> <span class="hide-menu">Place</span></a></li>
                    ...
                    <li><a href="index.html" class="waves-effect"><i class="linea-icon linea-ecommerce fa-fw"  data-icon="U"></i> <span class="hide-menu">Sales Report</span></a></li>
                    <li><a href="index.html" class="waves-effect"><i class="linea-icon linea-ecommerce fa-fw"  data-icon="3"></i> <span class="hide-menu">Inventory Report</span></a></li>
                    
                    <li class="nav-small-cap">--- System</li>
                    <li> <a href="javascript:void(0)" class="waves-effect"><i data-icon="F" class="linea-icon linea-software fa-fw"></i> <span class="hide-menu">Settings<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="login.html" class="waves-effect"><i class="icon-user fa-fw"></i> <span class="hide-menu">Clients</span></a></li>
                            <li><a href="login.html" class="waves-effect"><i class="icon-user fa-fw"></i> <span class="hide-menu">Manufacturer</span></a></li>
                            <li><a href="login.html" class="waves-effect"><i class="icon-user fa-fw"></i> <span class="hide-menu">Supplier</span></a></li>
                        </ul>
                    </li> 
                    <li><a href="index.html" class="waves-effect"><i class="linea-icon linea-aerrow fa-fw"  data-icon="&#xe034;"></i> <span class="hide-menu">FAQs</span></a></li>
                    <li><a href="index.html" class="waves-effect"><i class="linea-icon linea-aerrow fa-fw"  data-icon="&#xe03a;"></i> <span class="hide-menu">Log Out</span></a></li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <!--Breadcrumbs here commented out-->
                        ...
                        <div class="row row-in">
                                ...
                                <div class="white-box">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i data-icon="E" class="linea-icon linea-basic"></i>
                                            <h5 class="text-muted vb">NEW ORDERS</h5> </div>
                                ...
                                <div class="white-box">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
                                            <h5 class="text-muted vb">ALL ORDERS</h5> </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="white-box">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i class="linea-icon linea-basic" data-icon="&#xe00b;"></i>
                                            <h5 class="text-muted vb">NEW SALES</h5> </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h3 class="counter text-right m-t-15 text-primary">152</h3> </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="progress">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="white-box">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i class="linea-icon linea-basic" data-icon="&#xe016;"></i>
                                            <h5 class="text-muted vb">ALL SALES</h5> </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2018 &copy; Bewell Nutraceuticals Corporation </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
