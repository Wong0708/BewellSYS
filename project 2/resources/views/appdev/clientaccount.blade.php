                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="exampleModalLabel1" style="color:black; font-family:Helvetica,Arial,sans-serif;">Add Client Account</h4>
                            </div>
                            {!! Form::open(array('route'=>'clientaccount.store','id'=>'addproductform'))!!}
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="client" class="control-label" style="color:black; font-family:Helvetica,Arial,sans-serif;"><b>Company Name:</b></label>
                                    <input type="text" class="form-control" name="compname[]" required/>

                                    <span class="text-muted" style="font-size:12px; color:black; font-family:Helvetica,Arial,sans-serif;">Note: Enter the company name of the client.</span>
                                    <br>

                                    <label for="client" class="control-label" style="color:black; margin-top:10px; font-family:Helvetica,Arial,sans-serif;"><b>Company Email:</b></label>
                                    <input type="text" class="form-control" name="compemail[]" required/>
                                    <span class="text-muted" style="font-size:12px; color:black; font-family:Helvetica,Arial,sans-serif;">Note: Enter the company email.</span>
                                    <br>
                                    
                                    <!-- Add RM button -->
                                    <label for="order" class="control-label"> <button style="margin-top:10px; font-size:12px; box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23); font-family:Helvetica,Arial,sans-serif; width:160px; height:30px;"class="btn btn-success btn-rounded waves-effect waves-light productadd" type="button"><span class="btn-label"><i class="fa fa-plus-square"></i></span>Add Another Row</button></label>
                                            <a class="mytooltip" href="javascript:void(0)"><i class="fa fa-question-circle"></i><span class="tooltip-content3">Click this button to add another row of fields to input! </span> </a>
                                            <table class="table-bordered" data-height="250" data-mobile-responsive="true" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23); font-family:Helvetica,Arial,sans-serif; margin-top:10px; width:100%;">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        {{--<th></th> --}}
                                                        <th style="color:black; font-family:Helvetica,Arial,sans-serif;">Branch Address</th>
                                                        <th style="color:black; font-family:Helvetica,Arial,sans-serif;">Branch Contact Person</th>
                                                        {{--<th>Grams</th> --}} 
                                                        {{--<th>Price</th> --}} 
                                                        {{--<th>Current Qty</th> --}}
                                                        <th style="color:black; font-family:Helvetica,Arial,sans-serif;">Branch Contact Number</th>
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            @if(Session::has('success'))
                              ...
                              @endif
                            <h3 class="box-title m-b-0" style="color:black;">LIST OF CLIENT ACCOUNTS</h3>
