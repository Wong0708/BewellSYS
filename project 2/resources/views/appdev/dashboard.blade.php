                ...
                <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="white-box" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);">
                                ...
                                <div class="text-right"> <span class="text-muted" style="color:black;">Total Sales (PHP)</span>
                                    <h1><sup><i class="ti-arrow-up text-success"></i></sup> ₱{{number_format($totalSales,2)}}</h1> 
                                </div> 
