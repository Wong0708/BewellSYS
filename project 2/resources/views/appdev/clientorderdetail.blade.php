            ...
            <div class="container-fluid" style="background-color:#F5F5F5;">
                <div class="row bg-title" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title" style="color:black;">Order Details: CLOD-1</h4>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <div class="white-box text-center">
                                ...
                                <p class="text-muted">No. of Ordered Product/s</p>
                            </div>
                        </div>
                        <div class="col-md-3 col-xs-12 col-sm-6">
                                    ...
                                    <div class="white-box" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);">
                                        ...
                                        <div class="row" style="margin-top:10px; ">
                                                <div class="col-md-6 col-xs-6 b-r"> <strong>Client</strong>
                                                    <br>
                                                    <p class="text-muted">Mercury Drug Corporation</p>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-xs-6 b-r"> <strong>Email</strong>
                                                    <br>
                                                    <p class="text-muted">mercurydrug@gmail.com</p>
                                                </div>
                                                <div class="col-md-6 col-xs-6"> <strong>Location</strong>
                                                    <br>
                                                    <p class="text-muted">7 Mercury Ave Quezon City, Philippines</p>
                                                </div>
                                            </div>
                                    </div>
                            </div>
                ...
                <div class="col-lg-6 col-sm-6">
                        <div class="row">
                                ...
                                <div class="white-box" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);">
                                    ...
                                    <h3 class="box-title m-b-0" style="color:black;">Ordered Products</h3>
                                    <span class="text-muted" style="font-size:12px; color:black; font-family:Helvetica,Arial,sans-serif;">Note: This is section contains all the client order/s.</span>
                                    <br>
