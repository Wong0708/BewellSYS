            ...
            <div class="container-fluid" style="background-color:#F5F5F5;">
                <div class="row bg-title" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title" style="color:black;">Truck Details: TRK-{{$truck->id}}</h4>
                    </div>
                  ...
                  <div class="col-lg-6 col-sm-6">
                      ...
                      <div class="row">
                            <div class="col-lg-12 col-sm-12">
                                    ...
                                    <div class="white-box" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);">
                                        <h3 class="box-title m-b-0" style="color:black;">Truck Details</h3>
                                        <span class="text-muted" style="font-size:12px; color:black; font-family:Helvetica,Arial,sans-serif;">Note: This section contains the contact information of the truck.</span>
                                        <div class="row" style="margin-top:10px; ">
                                                <div class="col-md-6 col-xs-6 b-r"> <strong>Truck</strong>
                                                    <br>
                                                    <p class="text-muted">{{$truck->car_model}}</p>
                                                </div>
                                                <div class="col-md-6 col-xs-6 b-r"> <strong>Plate #</strong>
                                                ...
                                                <div class="col-md-6 col-xs-6 b-r"> <strong>Maximum Load</strong>
                                                    <br>
                                                    <p class="text-muted">{{$truck->max_box}} Boxes</p>
                                                </div>
                                                <div class="col-md-6 col-xs-6"> <strong>Availability</strong>
                                                    <br>
                                                    <p class="text-muted">{{$truck->availability}}</p>
                                                </div>
                                            </div>
                                    </div>
                            </div>
                    ...
                    <div class="row">
                            <div class="col-lg-12 col-sm-12">
                                    ...
                                    <div class="white-box" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);">
                                        <h3 class="box-title m-b-0" style="color:black;">Truck Update History</h3>
                                        <span class="text-muted" style="font-size:12px; color:black; font-family:Helvetica,Arial,sans-serif;">Note: This section contains all updates on this truck.</span>
                                        <p class="text-muted m-b-30"></p>
                                    <hr>
                                        <h3 style="font-weight:700; font-size:14px; color:black; font-family:Helvetica,Arial,sans-serif;">Truck Details: TRK-0001</h3>
                                    ...
                                    <div class="row">
                                            <div class="col-md-6 col-xs-12 col-sm-6">
                                                <div class="white-box text-center bg-purple">
                                                    <h1 class="text-white counter">50 Boxes</h1>
                                                    <p class="text-white">Current Load</p>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xs-12 col-sm-6">
                                                <div class="white-box text-center bg-info">
                                                    <h1 class="text-white counter">70 Boxes</h1>
                                                    <p class="text-white">Available Load</p>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                        <div class="col-lg-12 col-sm-12">
                                                ...
                                                <div class="white-box" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);">
                                                    ...
                                                    <span class="text-muted" style="font-size:12px; color:black; font-family:Helvetica,Arial,sans-serif;">Note: This section contains the schedule/s assigned for this truck.</span><br>
