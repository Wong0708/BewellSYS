        ...
        <div id="page-wrapper">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="client" class="control-label" style="color:black; font-family:Helvetica,Arial,sans-serif;"><b>Manufacturer:</b></label>
                                    ...
                                    <span class="text-muted" style="font-size:12px; color:black; font-family:Helvetica,Arial,sans-serif;">Note: Choose the manufacturer's address as this will serve also as the shipping address. <b style="color:#E53935;">*Required</b></span>
                                    <div class="white-box" style="background-color:#F5F5F5; margin-top:10px;">
                                        ...
                                        <table class="table color-bordered-table info-bordered-table" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23); font-family:Helvetica,Arial,sans-serif;">
                                            <thead>
                                                ...
                                                <span class="text-muted" style="font-size:12px; color:black; font-family:Helvetica,Arial,sans-serif;">Note: Choose the manufacturer's payment status on their ordered products. <b style="color:#E53935;">*Required</b></span>
                                            </br>
                                        ...
                                        @if(isset($orders))
                                            @foreach ($orders as $order)
                                                <tr>
                                                        ...
                                                        <td><a href={{ url('manufacturerorderdetail') }}>MLOD-1</td>
                                                ...
                                                <div class="modal fade statusModal" role="dialog">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal"></button>
                                                            ...
                                                            {!! Form::open(['route'=>['clientorder.update',$order->id],'method'=>'PUT','enctype'=>'multipart/form-data']) !!}
                                                            <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label for="orderStatus">Order Status:</label>
                                                                        <select name="orderStatus" class="form-control" id="orderStatus">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="submit" class="btn btn-danger statusSubmit">
                                                                            <span class='glyphicon glyphicon-remove'></span> Submit
                                                                    </button>
                                                                </div>
                                                            {!! Form::close() !!}
            ...
            <script type="text/javascript">
                ...
                $('#addproductform').submit(function() {
                    var verify = confirm("Do you wish to proceed to add the following materials?");
                    return verify;
                });
