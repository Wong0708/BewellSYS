            ...
            <div class="container-fluid" style="background-color:#F5F5F5;">
                <div class="row bg-title" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title" style="color:black;">Notifications</h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="#">Dashboard</a></li>
                            {{-- <li><a href="#">Order</a></li> --}}
                            <li class="active" style="color:#4c87ed;">Notifications</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            @if(Session::has('success'))
                              ...
                              @endif
                            <h3 class="box-title m-b-0" style="color:black;">LIST OF ALL NOTIFICATIONS</h3>
