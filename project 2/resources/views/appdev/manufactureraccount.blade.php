                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="exampleModalLabel1" style="color:black; font-family:Helvetica,Arial,sans-serif;">Add Manufacturer Account</h4>
                            </div>
                            {!! Form::open(array('route'=>'manufactureraccount.store','id'=>'addproductform'))!!}
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="client" class="control-label" style="color:black; font-family:Helvetica,Arial,sans-serif;"><b>Manufacturer Name:</b></label>
                                    <input type="text" class="form-control" name="manufname[]" required/>

                                    <span class="text-muted" style="font-size:12px; color:black; font-family:Helvetica,Arial,sans-serif;">Note: Enter the company name of the manufacturer.</span>
                                    <br>

                                    <label for="client" class="control-label" style="color:black; margin-top:10px; font-family:Helvetica,Arial,sans-serif;"><b>Manufacturer Address:</b></label>
                                    <input type="text" class="form-control" name="manufaddress[]" required/>
                                    <span class="text-muted" style="font-size:12px; color:black; font-family:Helvetica,Arial,sans-serif;">Note: Enter the manufacturer address.</span>
                                    <br>
                                    ...
                                    <span class="text-muted" style="font-size:12px; color:black; font-family:Helvetica,Arial,sans-serif;">Note: Enter the contact person of the manufacturer.</span>
                                    <br>
                                    ...
                                    <span class="text-muted" style="font-size:12px; color:black; font-family:Helvetica,Arial,sans-serif;">Note: Enter the manufacturer contact number.</span>
                                    <br>

                                    <label for="client" class="control-label" style="color:black; margin-top:10px; font-family:Helvetica,Arial,sans-serif;"><b>Manufacturer E-mail Address:</b></label>
                                    <input type="text" class="form-control" name="manufemail[]" required/>
                                    <span class="text-muted" style="font-size:12px; color:black; font-family:Helvetica,Arial,sans-serif;">Note: Enter the manufacturer e-mail address.</span>
                                    <br>
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            @if(Session::has('success'))
                              ...
                              @endif
                            <h3 class="box-title m-b-0" style="color:black;">LIST OF MANUFACTURER ACCOUNTS</h3>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                            @if(isset($manufacturers))
                                                ...
                                                <tr>
                                                    <td>{{'MN-'.$manufacturer->id}}</td>
                                                    <td>{{$manufacturer->mn_name}}</td>
                                                    <td>{{$manufacturer->mn_address}}</td>
