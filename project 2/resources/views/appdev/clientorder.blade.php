                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <label for="client" class="control-label" style="color:black; margin-top:10px; font-family:Helvetica,Arial,sans-serif;"><b>Expected Date:</b></label>
                                    <select name="client" class="form-control" id="client" style="margin-bottom:10px;">
                                                    @if(isset($clients))
                                                        @foreach ($clients as $client)
                                                            <option>{{$client->cl_name}}</option>
                                ...
                                <div class="white-box" style="background-color:#F5F5F5; margin-top:10px;">
                                        ...
                                        <table class="table color-bordered-table info-bordered-table" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23); font-family:Helvetica,Arial,sans-serif;">
                                            <thead>
                                                ...
                                                {{-- <h4  style="margin-top:10px; font-size:14px; color:black; font-family:Helvetica,Arial,sans-serif; text-transform:uppercase;"><b>Order Detail Report </b></h4> --}}
                                                {{-- <h4  style="margin-top:10px; font-size:14px; color:black; font-family:Helvetica,Arial,sans-serif; text-transform:uppercase;"><b>No. of Orders: 3 </b></h4> --}}
